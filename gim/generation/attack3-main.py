...
from gim_code.src.inversion import stable_diffusion_pipe, generate
...
parser.add_argument('--model_id', type=str, default='/data3/rdl/huggingface-mirror/dataroot/models/stabilityai/stable-diffusion-2-1-base')
#parser.add_argument('--model_id', type=str, default='/data2/huggingface-mirror/dataroot/models/stabilityai/stable-diffusion-2-1')
