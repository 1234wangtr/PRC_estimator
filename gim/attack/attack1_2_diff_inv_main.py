...
def print_json_keys(file_path,t):
    ...
    try:
        ...
        msg_tot1,msg_same1,inv_tot1,inv_same1,dup_plain_tot,dup_plain_same,dup_v15_tot,dup_v15_same,dup_v2_tot,dup_v2_same,dup_num = wim.dup_detect() 
        msg_tot2,msg_same2,inv_tot2,inv_same2,key_plain_tot,key_plain_same,key_v15_tot,key_v15_same,key_v2_tot,key_v2_same, = wim.part_key_recover() 
