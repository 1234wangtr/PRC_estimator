...
from llm.attack.watertxt_class import *
...
def print_json_keys(file_path,t):
    ...
    try:
        ...
        if msg_tot1 == 0:
            all_msg_tot3 -= 1
        elif msg_same1 / msg_tot1 >= threshold_dup:
            all_msg_succ3 += 1

        all_inv_tot3 += 1
        if inv_tot1 == 0:
            all_inv_tot3 -= 1
        elif inv_same1 / inv_tot1 >= threshold_dup:
            all_inv_succ3 += 1

        all_msg_tot4 += 1
        if msg_tot2 == 0:
            all_msg_tot4 -= 1
        elif msg_same2 / msg_tot2 >= threshold_key:
            all_msg_succ4 += 1
        all_inv_tot4 += 1

        if inv_tot2 == 0:
            all_inv_tot4 -= 1
        elif inv_same2 / inv_tot2 >= threshold_key:
            all_inv_succ4 += 1
        ...
        if key_plain_tot > 0:
            all_key_plain_tot += 1
            if key_plain_same / key_plain_tot >= threshold_key:
        ...
        if dup_plain_tot > 0:
            all_dup_plain_tot += 1
            if dup_plain_same / dup_plain_tot >= threshold_dup:
